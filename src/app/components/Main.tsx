...
export default function main() {
    ...
    return (
        ...
        <article className="relative ">
            <Image src="/1x/''Fichier 37.png" width={2000} height={2000} alt="Image background" className=" w-full object-cover z-30" />
            <Image src="/1x/''Fichier 36.png" width={2500} height={2500} alt="Image background" className="w-full absolute -z-10" />
